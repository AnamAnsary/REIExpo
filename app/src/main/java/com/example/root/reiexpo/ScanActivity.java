...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anylineOcrConfig.setMinCharHeight(5);
        anylineOcrConfig.setMaxCharHeight(25);
        anylineOcrConfig.setRemoveSmallContours(false);
        anylineOcrConfig.setMinSharpness(60);
        ...
        ibanResultView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                scannedDetails = IbanResultView.getScanResult();
                Log.d(TAG, "onResult() returned: " +scannedDetails);
                intent.putExtra("Details",scannedDetails);
                setResult(2,intent);
    ...
    public void onBackPressed() {
        if (ibanResultView.getVisibility() == View.VISIBLE) {
            Intent intent=new Intent();
            scannedDetails = IbanResultView.getScanResult();
            Log.w(TAG, "onResult() returned: " +scannedDetails);
            intent.putExtra("Details",scannedDetails);
            setResult(2,intent);
            ibanResultView.setVisibility(View.INVISIBLE);
            if (!scanView.isRunning()) {
